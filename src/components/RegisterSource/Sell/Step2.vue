    ...
    <div class="rent-content">
        ...
        <div>
            <group label-width="5em">
                ...
                <popup-picker :title="title3" :data="list3" v-model="value3" @on-show="onShow" @on-hide="onHide" @on-change="onChange" placeholder="请选择数字" ></popup-picker>
            </group>
...
<script>
  import {PopupPicker, Group, XButton, XHeader} from 'vux'
  export default {
    components: {
      PopupPicker,
      Group,
